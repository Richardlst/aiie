...
async def colorize(**kwargs) -> str:
    ...
    # 1. Chuyển đổi kwargs thành object request để validate dữ liệu
    request = ColorizeRequest(**kwargs)

    # 2. Gọi đến endpoint xử lý colorize của backend (ví dụ: /colorize)
    # Lưu ý: Endpoint này phụ thuộc vào cách bạn thiết lập ở SD_API_URL
    ...
    # 3. Parse kết quả trả về và lấy URL ảnh
